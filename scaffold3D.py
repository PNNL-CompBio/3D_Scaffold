...
from scaffold3D_data import scaffold3Dgen
dataset_name_to_class_mapping = {'scaffold3D': scaffold3Dgen}
...
def get_parser():
    ...
    train_parser.add_argument('--dataset_name', type=str, default='scaffold3D',
    ...
    train_subparsers.add_parser('3D_Scaffold', help='G-SchNet help',
    ...
    eval_subparsers.add_parser('3D_Scaffold', help='G-SchNet help',
    ...
    gen_subparsers.add_parser('3D_Scaffold', help='G-SchNet help',
