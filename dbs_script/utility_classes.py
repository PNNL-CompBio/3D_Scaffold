...
class Molecule:
    ...
    carbon, nitrogen, oxygen, fluorine, and hydrogen . Mainly relies on routines from Open Babel and RdKit.
    ...
    type_charges = {'H': 1, 'C': 6, 'N': 7, 'O': 8, 'F': 9, 'Mg': 12, 'Al': 13, 'Si': 14, 'P': 15, 'S': 16, 'Cl': 17}
    ...
    def get_fixed_connectivity(self, recursive_call=False):
        '''
        Attempts to fix the connectivity matrix using some heuristics.
